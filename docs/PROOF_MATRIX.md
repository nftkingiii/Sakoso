...
| Four equal categories | Stable category taxonomy and discovery intents | `/v1/categories`, route tests, and 2026-08-27 live smoke results | Partial; candidates found in all four, depth still needs measurement |
